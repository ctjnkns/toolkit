...
func TestTools_PushJSONToRemote(t *testing.T) {
	...
	_, _, err := testTools.PushJSONToRemote("http://example.com/example/path", foo, client)
	if err != nil {
...
func TestTools_CreateDirIfNo(t *testing.T) {
	var testTool Tools
...
var slugTests = []struct {
	...
	{name: "emtpy string", s: "", expected: "", errorExpected: true},
	...
	{name: "japanese string and roman characters", s: "hello world こんにちは世界", expected: "hello-world", errorExpected: true},
}
...
func TestTools_ReadJSON(t *testing.T) {
	...
	for _, e := range jsonTests {
		...
		testTool.MasJSONSize = e.maxSize
